    ...
    var gaugeData = [
      {
        ...
        gauge: {
          ...
          axis: {range: [null, 10]},
          steps: [
            {range: [0,2], color: "rgb(50,0,0)"},
            {range: [2,4], color: "rgb(100,0,0)"},
            {range: [4,6], color: "rgb(150,0,0)"},
           {range: [6,8], color: "rgb(200,0,0)"},
           {range: [8,10], color: "rgb(250,0,0)"}]
        }
      }
    ];
